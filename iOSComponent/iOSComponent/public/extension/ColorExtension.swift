...
import UIKit
extension UIColor{
    class func ColorWithRGBDataSource(red red:CGFloat, green:CGFloat, blue:CGFloat,alpha:CGFloat) -> UIColor{
        let reds        = red / 255.0
    ...
    private  class func getHexIntWith(hexStr:String)->Int{
        var a:[Int] = []
    ...
    //TODO:16进制转10进制
    private  class func getIntBy(hex:Character)->Int{
        switch hex{
        case "1":
            return 1
        case "2":
